...
public class MavenClientProperties extends MavenProperties {
	...
	/*
	 * @NestedConfigurationProperty private MavenProperties settings = new
	 * MavenProperties();
	 * 
	 * public MavenProperties getSettings() { return settings; }
	 * 
	 * public void setSettings(MavenProperties settings) { this.settings = settings;
	 * }
	 */
